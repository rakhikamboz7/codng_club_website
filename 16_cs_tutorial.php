...
text-align: justify; 
 ...
 <body>
  ...
  <!-- <div class="intro">This is the first step to begin with frontend. Coding Club provides
    ...
    <div class="container">
      <div class="sidebar">
        <a href="#html-intro" class="topic-link" onclick="showContent('topic1')">CSS Introduction</a><hr>
        <a href="#" class="topic-link" onclick="showContent('topic2')">Topic 2</a><hr>

        <a href="#elements-tags" class="topic-link" onclick="showContent('topic2')">Topic 2</a><hr>
        
        <a href="#Text Formatting" class="topic-link" onclick="showContent('topic2')">Topic 2</a><hr>
        <a href="#Links-images" class="topic-link" onclick="showContent('topic2')">Topic 2</a><hr>
...
<div class="referrences"><h1>Topic 2</h1><iframe width="336" height="124" src="https://www.youtube.com/embed/BsDoLVMnmZs" 
  ...
  <div class="referrences"><h1>Topic 3</h1><iframe width="336" height="124" src="https://www.youtube.com/embed/BsDoLVMnmZs" 
    ...
    <div class="b-button">
    <a href="HTML_tutorial.php" class="html-tutorial">Learn CSS</a>
    </div>
    <section>
